...
This is my work in progress to make it cross-platform.  I have removed windows specific timing code, removed the direct dependency on the windows encryption API.  I have replaced it with the Delphi built-in functions for Hashing and the Synapse library for Random number generation.  I have also removed the code for old versions of Delphi. It should work on Delphi 10.3+ and maybe of the other more recent older versions.
